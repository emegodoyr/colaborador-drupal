...
<div class="page_title_wrapper">
  <div class="container">
    <div class="row">
        ...
        <div class="span6">
          <?php if (theme_get_setting('breadcrumbs', 'modern')): ?>
    ...
    <div class="row">
      ...
      <div class="span3">
        <?php print render($page['footer_firth']); ?>
          ...
          <?php if (theme_get_setting('social_links', 'modern')): ?>
          <?php 
          $facebook = check_plain(theme_get_setting('facebook', 'modern')); 
          $twitter = check_plain(theme_get_setting('twitter', 'modern')); 
          $linkedin = check_plain(theme_get_setting('linkedin', 'modern'));
          $googleplus = check_plain(theme_get_setting('googleplus', 'modern'));
          $dribbble = check_plain(theme_get_setting('dribbble', 'modern'));
          $pinterest = check_plain(theme_get_setting('pinterest', 'modern'));
          $tumblr = check_plain(theme_get_setting('tumblr', 'modern'));
          $vimeo = check_plain(theme_get_setting('vimeo', 'modern'));
          $youtube = check_plain(theme_get_setting('youtube', 'modern'));  
          $flicker = check_plain(theme_get_setting('flicker', 'modern'));
