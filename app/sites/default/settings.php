...
$databases = array ( 'default' =>
  ...
  'default' =>
  array (
  'database' => 'colaborador', // this is your database name
   'username' => 'admin',  // replace with your database username
  'password' => 'colaborador',// replace with your database password
   'host' => 'database', // default is localhost, probaddy IP of mysql server
  'port' => '',
  'driver' => 'mysql',
  'prefix' => '',
  ),
...
$conf['soap'] = array( 'url' => 'http://192.168.0.150:8280/services/', );
$conf['client'] = array( 'IdSociedad' => '3455',);
